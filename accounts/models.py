...
class PasswordResetOTP(models.Model):
    customer = models.ForeignKey(CustomerProfile, on_delete=models.CASCADE, related_name='password_reset_otps')
    ...
    def __str__(self):
        return f"Password reset OTP for {self.customer.whatsapp_number}"
