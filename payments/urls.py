...
urlpatterns = [
    ...
    path('facebook-addon-plans/<int:wp_site_id>/', views.facebook_addon_plans_view, name='facebook_addon_plans'),
    path('facebook-addon-plans/', views.facebook_addon_plans_view, {'wp_site_id': None}, name='facebook_addon_plans_standalone'),
    path('checkout/facebook-addon/<int:plan_id>/<int:wp_site_id>/', views.facebook_addon_checkout_view, name='facebook_addon_checkout'),
    path('checkout/facebook-addon/<int:plan_id>/', views.facebook_addon_checkout_view, {'wp_site_id': None}, name='facebook_addon_checkout_standalone'),
    path('ads-addon-plans/<int:wp_site_id>/', views.ads_addon_plans_view, name='ads_addon_plans'),
    path('ads-addon-plans/<int:wp_site_id>/free-trial/', views.start_ads_free_trial, name='ads_free_trial'),
    path('checkout/ads-addon/<int:plan_id>/<int:wp_site_id>/', views.ads_addon_checkout_view, name='ads_addon_checkout'),
