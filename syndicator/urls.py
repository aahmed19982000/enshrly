...
urlpatterns = [
    ...
    path('sources/test-all/', views_ai.SourceTestAllView.as_view(), name='sources_test_all'),
    path('sources/<int:pk>/preview/', views_ai.SourcePreviewView.as_view(), name='source_preview'),
    ...
    path('saas/facebook-plans/', saas_admin_views.FacebookAddonPlanListView.as_view(), name='saas_facebook_plans'),
    path('saas/facebook-plans/add/', saas_admin_views.FacebookAddonPlanCreateView.as_view(), name='saas_facebook_plan_add'),
    path('saas/facebook-plans/<int:pk>/edit/', saas_admin_views.FacebookAddonPlanUpdateView.as_view(), name='saas_facebook_plan_edit'),
    path('saas/facebook-plans/<int:pk>/delete/', saas_admin_views.FacebookAddonPlanDeleteView.as_view(), name='saas_facebook_plan_delete'),
    path('saas/ads-plans/', saas_admin_views.AdsAddonPlanListView.as_view(), name='saas_ads_plans'),
